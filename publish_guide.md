...
### ステップ 3: 一般公開URLの確認
1. 設定保存後、1〜2分ほどで自動ビルドが走り公開されます。
2. ページをリロードすると、Pages設定画面の最上部に公開されたWebサイトのURLが表示されます。
   * URLの形式: `https://<ユーザー名>.github.io/<リポジトリ名>/`
3. このURLをコピーし、一般のユーザー（SNS、LINEなど）に共有すれば、誰でもスマホやPCからカレンダーを開くことができます。
